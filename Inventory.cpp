...
void Inventory::selectitem()
{
    ...
    char Movement = '\0';
    int Choice = 0;
    cout << "(1) Select this item | (2) Move to a different item\n";
    cin >> Choice;
    if (Choice == 1) {
...
{
    int select = 0;
    cout << "Would you like to inspect, equip or discard this weapon?\n";
    cout << "(1) Inspect | (2) Use | (3) Discard\n";
    cin >> select;
    if (select == 1)
    {
